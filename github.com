...
<html lang="en">
  ...
  <link crossorigin="anonymous" href="https://assets-cdn.github.com/assets/github-d5b96b259d9b0c75f0bdf46a469ce6d35a33b3b53ad365d5b5a5c1f55950ff0c.css" media="all" rel="stylesheet" />
  ...
  <meta name="request-id" content="F21C:19D0A:C2164:124AAF:59541D72" data-pjax-transient>
...
<meta content="collector.githubapp.com" name="octolytics-host" /><meta content="github" name="octolytics-app-id" /><meta content="https://collector.githubapp.com/github-external/browser_event" name="octolytics-event-url" /><meta content="F21C:19D0A:C2164:124AAF:59541D72" name="octolytics-dimension-request_id" /><meta content="iad" name="octolytics-dimension-region_edge" /><meta content="iad" name="octolytics-dimension-region_render" />
  ...
  <meta name="user-login" content="">
    ...
    <meta name="js-proxy-site-detection-payload" content="ZTM1ZWEzODk0NDllOTY3NDIzZjU1YzMyYWIxMDA5MTNmNTZiZGY3MGVhY2RiZTQ0NDExNGQ2NDBiNTA1MTk4MHx7InJlbW90ZV9hZGRyZXNzIjoiMzguOTIuMTQzLjEyOSIsInJlcXVlc3RfaWQiOiJGMjFDOjE5RDBBOkMyMTY0OjEyNEFBRjo1OTU0MUQ3MiIsInRpbWVzdGFtcCI6MTQ5ODY4NDc4NiwiaG9zdCI6ImdpdGh1Yi5jb20ifQ==">


  <meta name="html-safe-nonce" content="48e47418107b15887193d65060e6242d9212cded">
    ...
    <div class="d-md-flex flex-items-center gutter-md-spacious">
      <div class="col-md-7 text-md-left ">
        ...
        <div class="mx-auto col-sm-8 col-md-5 hide-sm rounded-1 bg-gray-light pt-4 pb-5">
          <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/join" autocomplete="off" class="home-hero-signup js-signup-form" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="fF3fZGzHwYb0/1l7/U2Dr/IRywPESKrYqNKJoYBjg5YS8KR5Hce6xX23umapsoJ2dZty0erf/dkLBoSWMkfr7w==" /></div>            <dl class="form">
              <dd>
                <label class="form-label text-gray f5" for="user[login]">Username</label>
                <input type="text" name="user[login]" id="user[login]" class="form-control form-control-lg input-block" placeholder="Pick a username" data-autocheck-url="/signup_check/username" data-autocheck-authenticity-token="/lvrhD0iWxCGEwa0/5hXDlh02FGOxbWS6ErTHQ8eywvujREhnRcpSw8nKx4R2nBsa6+wE3Z4Ob4guz9UuZx8Bg==" autofocus>
              </dd>
            </dl>
            <dl class="form">
              <dd>
                <label class="form-label text-gray f5" for="user[email]">Email</label>
                <input type="text" name="user[email]" id="user[email]" class="form-control form-control-lg input-block js-email-notice-trigger" placeholder="Your email address" data-autocheck-url="/signup_check/email" data-autocheck-authenticity-token="+z/qyOqqfERKK7tWaUw6DdGiNu/s/BSmRaD3tg/Bod6o7Z1j3NC0miMiYis/DERUHRKmNff0/pEDvxFCY7X5Xw==">
              </dd>
            </dl>
            <dl class="form">
              <dd>
                <label class="form-label text-gray f5" for="user[password]">Password</label>
                <input type="password" name="user[password]" id="user[password]" class="form-control form-control-lg input-block" placeholder="Create a password" data-autocheck-url="/signup_check/password" data-autocheck-authenticity-token="lmTVuY1sC+p8P9lGLXv5lbunUE4k7VKwtEwhR80hcTdA3fiS1YE5pH016JpUD18RWirIvXLBXY7MEWg+PCG1jw==">
              </dd>
            ...
            <input class="form-control" name="timestamp" type="hidden" value="1498684785971" />
<input class="form-control" name="timestamp_secret" type="hidden" value="a089dd04e1e0cf22cf36001aee2700f068c895a3f42031fec367ab12987b52a2" />
